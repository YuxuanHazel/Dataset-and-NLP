...
csv_path = r"D:\Liuyuxuan\MUC\Slp\Dataset and NLP\final\task\ALL_clustered_texts.csv"
model_path = r"D:\Liuyuxuan\MUC\Slp\Dataset and NLP\final\fine_tuned_BART\fine_tuned_bart_model"
output_dir = r"D:\Liuyuxuan\MUC\Slp\Dataset and NLP\final\task\SHAP_output\BART"
model_name = "BART-DS"
...
df = df[df["id"].isin(range(1,16))].dropna(subset=["text"])
