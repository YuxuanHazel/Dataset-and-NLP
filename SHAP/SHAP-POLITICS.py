...
model_path = r"D:\Liuyuxuan\MUC\Slp\Dataset and NLP\final\fine_tuned_POLITICS\Model_FT_POLITICS"
output_dir = r"D:\Liuyuxuan\MUC\Slp\Dataset and NLP\final\task\SHAP_output\POLITICS"
model_name = "POLITICS-GPT"

os.makedirs(output_dir, exist_ok=True)


df = pd.read_csv(csv_path)
df = df[df["id"].isin(range(31,46))].dropna(subset=["text"]) # Change id to switch different LLMs' answer
